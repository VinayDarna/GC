...
@implementation SCObjectSelectionAttributes (WebServices)

+ (id)attributesWithObjectsWebServiceDefinition:(SCWebServiceDefinition *)definition
...
- (id)initWithObjectsWebServiceDefinition:(SCWebServiceDefinition *)definition
                   allowMultipleSelection:(BOOL)allowMultipleSel
                         allowNoSelection:(BOOL)allowNoSel
{
    if( (self=[self init]) )
