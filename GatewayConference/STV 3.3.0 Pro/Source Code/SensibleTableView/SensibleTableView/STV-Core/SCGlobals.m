...
#if defined(SC_STVLITE) || defined(SC_STVTRIAL)
#import "SCLicenseEngine.h"
#endif
@implementation SCLicenseManager

+ (id)licenseEngine
{
    static id licenseEngine = nil;
    
#ifdef SC_LICENSEENGINE
    licenseEngine = [[SCLicenseEngine alloc] init];
#endif
    
    return licenseEngine;
}

+ (id)performEngineStringSelector:(NSString *)stringSelector
{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
    SEL selector = NSSelectorFromString(stringSelector);
    return [[self licenseEngine] performSelector:selector];
#pragma clang diagnostic pop    
}

+ (id)performEngineStringSelector:(NSString *)stringSelector withObject:(id)object
{
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Warc-performSelector-leaks"
    SEL selector = NSSelectorFromString(stringSelector);
    return [[self licenseEngine] performSelector:selector withObject:object];
#pragma clang diagnostic pop
}

+ (UIView *)licenseViewForWidth:(CGFloat)width
{
    return [self performEngineStringSelector:@"licenseViewForWidth:" withObject:[NSNumber numberWithFloat:width]];
}

+ (NSObject *)unlicensedObjectWithName:(NSString *)name
{
    return [self performEngineStringSelector:@"unlicensedObjectWithName:" withObject:name];
}

+ (NSObject *)unlicensedCoreDataObject
{
    return [self performEngineStringSelector:@"unlicensedCoreDataObject"];
}

+ (NSObject *)unlicensedWebServiceObject
{
    return [self performEngineStringSelector:@"unlicensedWebServiceObject"];
}

+ (NSObject *)unlicensediCloudObject

{
    return [self performEngineStringSelector:@"unlicensediCloudObject"];
}

+ (BOOL)isUnlicensedObject:(NSObject *)object
{
    return [(NSNumber *)[self performEngineStringSelector:@"isUnlicensedObject:" withObject:object] boolValue];
}

+ (NSString *)nameForUnlicensedObject:(NSObject *)object
{
    return [self performEngineStringSelector:@"nameForUnlicensedObject:" withObject:object];
}
