...
- (void)performInitialization
{
    ...
    _previousNextSegmentedControl.segmentedControlStyle = UISegmentedControlStyleBar;
    ...
    _clearButton = [[UIBarButtonItem alloc] initWithTitle:clearTitle style:UIBarButtonItemStyleBordered target:self action:@selector(clearTapped)];
}
