...
@interface SCWebServiceDefinition : SCDictionaryDefinition
{
    ...
    NSString *_fetchObjectsAPI;
    NSMutableDictionary *_fetchObjectsParameters;
    NSString *_resultsKeyName;
    NSString *_atomicResultKeyName;
    NSString *_batchSizeParameterName;
    NSString *_batchStartIndexParameterName;
    NSUInteger _batchInitialStartIndex;
    NSString *_nextBatchURLKeyName;
    NSString *_objectIdKeyName;
    NSString *_readOnlyKeyNames;
    NSString *_insertObjectAPI;
    NSMutableDictionary *_insertObjectParameters;
    NSString *_updateObjectAPI;
    NSMutableDictionary *_updateObjectParameters;
    NSString *_deleteObjectAPI;
    NSMutableDictionary *_deleteObjectParameters;
}
...
@property (nonatomic, readonly) NSMutableDictionary *updateObjectParameters;
