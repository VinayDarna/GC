...
- (void)mailComposeController:(MFMailComposeViewController*)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError*)error
{
	...
	switch (result)
	{
		case MFMailComposeResultCancelled:
        {
            ...
            bgImage     = [UIImage imageNamed:@"bg-yellow.png"];
            iconImage   = [UIImage imageNamed:@"dropdown-alert"];
            delay       = 10.0f;
			break;
        }
		...
		case MFMailComposeResultSent:
        {
            ...
            bgImage     = [UIImage imageNamed:@"bg-blue.png"];
            iconImage   = [UIImage imageNamed:@"dropdown-info"];
            delay       = 5;
			break;
        }
		...
		case MFMailComposeResultFailed:
        {
            ...
            bgImage     = [UIImage imageNamed:@"bg-red.png"];
            iconImage   = [UIImage imageNamed:@"dropdown-error"];
            delay       = 0.0f;
			break;
        }
