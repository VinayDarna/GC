...
@protocol ARParentViewControllerDelegate;
...
@property (nonatomic, retain) id<ARParentViewControllerDelegate>  parentDelegate;
...
@protocol ARParentViewControllerDelegate <NSObject>
